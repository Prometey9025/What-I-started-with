...
public class simpleP {
    public static void main(String[] args) {
        ...
        int[] index1= new int[(key1[0]*key1[1]*p)- text.length];
        int[] index2= new int[(key1[0]*key1[1]*p)- text.length];
        ...
        for(int a=0,k=0;a<p;a++){
            for(int i=0; i<key1[0];i++) {
                for (int j = 0; j < key1[1]; j++,k++) {
                    for(int m =0;m<(key1[0]*key1[1]*p)- text.length;m++) {
                        if (k >= text.length ) {
                            start[i][j][a] = '#';
                        }
                        else{
        ...
        for(int a=0,k=0;a<p;a++){
            for(int j=0;j<key1[1];j++){
                for(int i=0;i<key1[0];i++){
                    for(int l=0;l<(key1[0]*key1[1]*p)- text.length;l++){
                        if(i==index1[l]&&j==index2[l]&&a==index3[l]){
                            tabl1[i][j][a]='#';
                            z++;
                        }
                    }
